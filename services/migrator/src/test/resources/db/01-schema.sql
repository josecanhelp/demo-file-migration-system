-- Target database schema, kept identical to infra/postgres/init/01-schema.sql
-- so the store layer tests run against the same tables the real Postgres
-- target database is provisioned with.
